...
#Variables for placement of objects on gameboard, drawing/writing on the gameboard
...
#Variables for difficulty mode selection
...
######################
#H. Before starting gameplay, difficulty selections 
######################
...
Very Hard\t(20 x 20 puzzle)--type "v"\n'''
    ...
    if not(select_diffs_per_level):
        print('pass thru select_diff_this_level')
        pass
    else:
...
def increasing_diffs(m_levels):
    ...
    print(f'after increasing_diffs(), with max_levels of {m_levels}, level_list is {level_list}\n\n')
