#V1.2 In this file, I have rearranged the initialization (with the intention of functionalizing setup)
#This version also has a fixed function for printing the game_board
