...
#### Remove multi-line comment on  lines 88 - 135 to view the numbers and grid.
'''
...
# print_game_board() is for debugging purposes. It prints the all the values of the matrix "game_board," such that row 0 
